			...
			>
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[50px] md:text-justify text-center">
					...
					<div className="lg:ml-[50px] text-center">
						...
						{showButton && (
								<div
									className="mt-[80px] ml-[10px] fixed xl:bottom-[270px] lg:bottom-[320px] md:bottom-[80px] bottom-[50px] xl:right-[100px] lg:right-[50px] xs:right-[20px] xxxs:right-[10px] md:right-[20px]  bg-[#821fa0] w-10 h-10 rounded-full flex items-center justify-center z-50"
									onClick={scrollToTop}
								>
